...
/*!
 *  @brief RCC AHB1 Peripherals Clock Control Macro Definitions
 *  @param tempvalue bu değer sıcaklık değrini tutmak için kullanılır
 *  @return sıcaklık değerini int olarak döndürür
 *
 * */
